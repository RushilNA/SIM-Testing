...
/**
 * CTRE (Cross The Road Electronics) implementation of the Flywheel IO interface. This class handles the hardware
 * interface for a dual-motor flywheel system using TalonFX motors.
 */
public class FlywheelIOCTRE implements FlywheelIO {
    ...
    /**
     * Constructs a new FlywheelIOCTRE instance. Initializes motor controllers with appropriate configuration and sets
     * up status signals.
     */
