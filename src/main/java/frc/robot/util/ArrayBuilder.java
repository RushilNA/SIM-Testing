...
public class ArrayBuilder {
    ...
    public static SwerveModulePosition[] buildSwerveModulePosition() {
        ...
        SwerveModulePosition[] modulePositions = new SwerveModulePosition[Constants.PP_CONFIG.numModules];
    ...
    public static ModuleIOInputsAutoLogged[] buildModuleAutoLogged() {
        ...
        ModuleIOInputsAutoLogged[] moduleAutoLogged = new ModuleIOInputsAutoLogged[Constants.PP_CONFIG.numModules];
    ...
    public static Alert[] buildAlert(String alarmText) {
        ...
        Arrays.setAll(alerts, i -> new Alert(alarmText + " " + Integer.toString(i) + ".", AlertType.kError));
        return alerts;
    }
}
