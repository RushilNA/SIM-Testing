...
public class Conversions {
    public static Distance rotationsToMeters(Angle rotations, double gearRatio, Distance wheelRadius) {
    ...
    public static AngularVelocity metersToRotationsVel(LinearVelocity meters, double gearRatio, Distance wheelRadius) {
        /* Divide the distance by the wheel radius to get radians */
