...
//         inputs.elevatorDistance = Conversions.rotationsToMeters(inputs.encoderPosition, 1, elevatorRadius);
//     }
...
//         leader.setControl(new PositionVoltage(Conversions.metersToRotations(distance, 1, elevatorRadius)));
//     }
