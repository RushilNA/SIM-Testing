...
public class ElevatorIOCTRE implements ElevatorIO {
    ...
    private TalonFXConfiguration createMotorConfiguration() {
        ...
        config.Slot0.kP = 5; // Proportional gain
        config.Slot0.kI = 0; // Integral gain
        config.Slot0.kD = 0.5; // Derivative gain
    ...
    public void updateInputs(ElevatorIOInputs inputs) {
        ...
        inputs.elevatorDistance =
                frc.robot.util.Conversions.rotationsToMeters(inputs.leaderPosition, GEAR_RATIO, elevatorRadius);
    }
    ...
    public void setDistance(Distance distance) {
        ...
        leader.setControl(new PositionVoltage(
                frc.robot.util.Conversions.metersToRotations(distance, GEAR_RATIO, elevatorRadius)));
    }
