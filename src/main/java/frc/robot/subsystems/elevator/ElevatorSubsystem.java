...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    private final TalonFX elevatorMotor2 = new TalonFX(2);
    ...
    private final SmartMotorController motor = new TalonFXWrapper(elevatorMotor, DCMotor.getKrakenX60(2), motorConfig);
