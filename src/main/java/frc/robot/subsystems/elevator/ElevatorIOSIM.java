...
/**
 * Simulation implementation of the elevator subsystem. This class extends ElevatorIOCTRE to provide a physics-based
 * simulation of the elevator mechanism using WPILib's simulation classes.
 *
 * <p>The simulation models: - Dual Kraken X60 FOC motors - Realistic elevator physics including gravity - Position and
 * velocity feedback through simulated encoders - Battery voltage effects
 */
public class ElevatorIOSIM extends ElevatorIOCTRE {
    ...
    /**
     * Constructs a new ElevatorIOSIM instance. Initializes the physics simulation with realistic parameters including:
     * - Dual Kraken X60 FOC motors - 10 pound carriage mass - 8 foot maximum height - Gravity simulation enabled
     */
    ...
    public void updateInputs(ElevatorIOInputs inputs) {
        ...
        Angle position =
                Conversions.metersToRotations(Meters.of(motorSimModel.getPositionMeters()), GEAR_RATIO, elevatorRadius);

        // Convert linear velocity to angular velocity based on encoder
        AngularVelocity velocity = Conversions.metersToRotationsVel(
                MetersPerSecond.of(motorSimModel.getVelocityMetersPerSecond()), GEAR_RATIO, elevatorRadius);
